...
public class ChatMessageController {
    ...
    public void sendMessage(@DestinationVariable("chatRoomId") Long chatRoomId,
        ...
        ChatMessageResponseDto chatMessageResponseDto = chatMessageService.sendMessage(chatRoomId, chatMessageRequestDto);
    ...
    public void updateMessage(@DestinationVariable("chatRoomId") Long chatRoomId,
                              @Payload ChatMessageRequestDto chatMessageRequestDto) {
        ChatMessageResponseDto chatMessageResponseDto = chatMessageService.updateMessage(chatRoomId, chatMessageRequestDto);
    ...
    public void deleteMessage(@DestinationVariable("chatRoomId") Long chatRoomId,
                              @Payload ChatMessageRequestDto chatMessageRequestDto) {
        ChatMessageResponseDto chatMessageResponseDto = chatMessageService.deleteMessage(chatMessageRequestDto);
